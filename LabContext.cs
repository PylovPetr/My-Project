        ...
        protected override void Seed(LabContext context)
        {
                ...
                var childrens = new List<Parental>
            {
               ...
               new Parental {FIO_rod = "ПП2", Phone= "8(495)111-000-56", TroopLists = new[] { tp1, tp4, tp5 }},
                ...
                Children child1 = new Children { FIO_reb = "Колодезов Роберт Андреевич", Birthdate = "12.04.02", Parental = childrens[0], TroopList = tp1 };
                Children child2 = new Children { FIO_reb = "Фирман Том Карлович", Birthdate = "12.05.02", Parental = childrens[1], TroopList = tp2 };
                Children child3 = new Children { FIO_reb = "Фирман Том Карлович", Birthdate = "12.05.02", Parental = childrens[2], TroopList = tp3 };
